...
public class Main {
    ...
    private static void startMaster() throws RemoteException, AlreadyBoundException {
        ...
        MasterServerClientInterface stub = (MasterServerClientInterface) UnicastRemoteObject.exportObject(master, Configuration.SERVER_PORT);
    ...
    private static void getReplica() throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            ReplicaServerClientInterface stub = (ReplicaServerClientInterface) UnicastRemoteObject.exportObject(rs, Configuration.REPLICA_PORT);
